...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header my-2">
            <h3 class="card-title">Serviceable(s) - Report on the Count Property, Plant and Equipment (RPCPPE)</h3>
        </div>
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3">
                            ...
                            <div class="col">
                                <label for="type" class="bold">Status</label>
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped" id="servTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p>{{ $rpcppe->serv_article }}</p>
                        </td>
                        <td>
                            <p>{{ !empty($rpcppe->serv_acctg) ? $rpcppe->serv_acctg : "N/A"  }}</p>
                        </td>
                        <td>
                            <p>{{ !empty($rpcppe->serv_prop) ? $rpcppe->serv_prop : "N/A"  }}</p>
                        </td>
                        <td class="text-center">
                            <p>{{ !empty($rpcppe->serv_date) ? date('M d, Y', strtotime($rpcppe->serv_date)) : "N/A"  }}
                            </p>
                        </td>
                        <td class="text-center">
                            <p>{{ number_format($rpcppe->serv_value * $rpcppe->serv_qty, 2) }}</p>
                        </td>
                        <td class="text-center">
                            @if($rpcppe->serv_status == 1)
                            <span class="badge rounded-pill text-bg-success">Serviceable</span>
                            @elseif($rpcppe->serv_status == 0)

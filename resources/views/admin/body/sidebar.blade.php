        ...
        <div class="sb-sidenav-menu">
            <div class="nav text-center">
                <img class="rounded-circle py-1"
                    ...
                    alt="User Profile">
                <hr>
                <p class="text-white">{{ $user_log->username }}</p>
                <hr>
                ...
                <div class="collapse" id="collapseService" aria-labelledby="headingOne"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('all.rpcppe') }}"><i
                                class="fa-solid fa-list"></i>&nbsp;RPCPPE</a>
                        <a class="nav-link" href="{{ route('all.ics') }}"><i class="fa-solid fa-list"></i>&nbsp;ICS</a>
                    </nav>
                </div>
                <hr>
                ...
                <div class="collapse" id="collapseSettings" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('all.offices') }}"><i
                                class="fa-solid fa-building"></i>&nbsp;Offices</a>
                        <a class="nav-link" href="{{ route('all.ppe') }}"><i class="fa-solid fa-gears"></i>&nbsp;PPE
                            Account</a>
                        <!-- <a class="nav-link" href="layout-static.html">Categories</a> -->
                        <a class="nav-link" href="{{ route('all.units') }}"><i
                                class="fa-solid fa-boxes-stacked"></i>&nbsp;Unit Types</a>
                        <a class="nav-link" href="{{ route('all.acct') }}"><i class="fa-solid fa-users"></i>&nbsp;User
                            Management</a>
                        <a class="nav-link" href="{{ route('all.class') }}"><i class="fa-solid fa-bars"></i>&nbsp;Class
                            Reports</a>
                    </nav>
                </div>
            </div>

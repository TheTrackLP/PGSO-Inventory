...
<head>
    ...
    <title>{{ $ofc->office_acronym }} | {{ $ppe_acct->ppe_name }} ({{ $ppe_acct->ppe_code }})</title>
...
td.remarks-column p {
    ...
    padding-bottom: 2px;
    /* Optional: Adjust spacing between text and line */
    margin-bottom: 4px;
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 10px">
            ...
            <div class="col-2 text-center">
                <h5><b><u>{{ $ofc->office_incharge }}</u></b></h5>
                <p>(Name of Accountable Officer)</p>
            </div>
            <div class="col-3 text-center">
                <h5><b><u>{{ $ofc->office_position }}</u></b></h5>
                <p>(Official Designation)</p>
            </div>
            <div class="col-2 text-center">
                <h5><b><u>{{ $ofc->office_name }}
                        </u></b></h5>
                ...
                <table class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr data-value="{{ $rpcppe->serv_value }}" data-qty="{{ $rpcppe->serv_qty }}">
                            <td>{{ $rpcppe->serv_article }}</td>
                            <td class="">{!! $rpcppe->serv_desc !!}</td>
                            ...
                            <td class="text-center">
                                {{ !empty($rpcppe->serv_value) ? number_format($rpcppe->serv_value, 2) : null }}</td>
                            <td class="text-center">
                ...
                <footer>
                    ...
                    <div class="row mx-2">
                        <div class="col-6 text-center">
                            <h5><strong><u>{{ $ofc->office_incharge}}</u></strong></h5>
                            <h5 style="margin-bottom: 3rem;">Signature Over Printed Name</h5>
                            <h5><strong><u>{{ $ofc->office_position }}</u></strong></h5>
